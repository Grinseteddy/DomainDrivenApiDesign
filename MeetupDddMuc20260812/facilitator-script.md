...
critic. They are not the modeler. If your table goes quiet and stares at a screen,
...
**Three proposes, three challenges.** The seeder, the context finder and the prototype skill
...
1. *"Our actor is ___ and the behavior we wanted to change is ___."*
